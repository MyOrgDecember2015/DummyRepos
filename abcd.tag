...
<div class="userRegister">
	...
	<form:form method="post" commandName="kickerRegisterForm" action="${action}">
		<div class="form_field-elements js-recaptcha-captchaaddon">
			...
			<formElement:formInputBox idKey="register.panNumber" labelKey="register.panNumber" path="panNumber" inputCSS="text" mandatory="true"/>
			<formElement:formCheckbox idKey="register.marketingFlag" labelKey="register.marketingFlag" path="marketingFlag" inputCSS="text" mandatory="true"/>
			<formElement:formInputBox idKey="register.loyaltyCardNumber" labelKey="register.loyaltyCardNumber" path="loyaltyCardNumber" inputCSS="text" mandatory="true"/>
			<formElement:formInputBox idKey="register.secondaryEmail" labelKey="register.secondaryEmail" path="secondaryEmail" inputCSS="text" mandatory="true"/>
